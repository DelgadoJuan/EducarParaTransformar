...
public class DesktopAppApplication {
	...
	public static void main(String[] args) {
		...
		EstudianteEntity estudiante = new EstudianteEntity("45566778", "Nico", "ncerezo07@gmail.com",
		...
		estudianteRepository.save(new EstudianteEntity("52000000", "Enzo", "erwrewrwe@gmail.com",
				bCryptPasswordEncoder.encode("asd123"), LocalDate.of(2001, 5, 24), Roles.Estudiante));
